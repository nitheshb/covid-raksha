...
import 'package:flutter_covid_dashboard_ui/screens/village.dart';
...
class DistrictWiseOrders extends StatefulWidget {
   DistrictWiseOrders({Key key, @required this.districtName}) : super(key: key);
  final String districtName;
  @override
  _DistrictWiseOrdersState createState() => _DistrictWiseOrdersState();
}

class _DistrictWiseOrdersState extends State<DistrictWiseOrders> {
                ...
                Container(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      donutCard(Colors.indigo, "L- 120"),
                      donutCard(Colors.yellow, "K-130"),
                      donutCard(Colors.greenAccent, "F-34"),
                      donutCard(Colors.pinkAccent, "D-0"),
                    ],
                  ),
                )
              ],
        ...
        child: Column(
            ...
            Column(
              children: [
               ...
               onTap: (){
                            ...
                            context,
                            MaterialPageRoute(
                                builder: (BuildContext context) => VillageWiseOrders(VillageName: 'TPGUDUR')
                                    ));
                              },
            child: vaweCard(
              context,
          ...
          InkWell(
               onTap: (){
                            ...
                            context,
                            MaterialPageRoute(
                                builder: (BuildContext context) => VillageWiseOrders(VillageName: 'Podalukur')
                                    ));
                              },
            child:   vaweCard(
            context,
